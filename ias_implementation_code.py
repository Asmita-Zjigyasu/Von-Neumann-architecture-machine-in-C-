Memory = [
    '0000000100000000010000001111000000000010',  # load a, cond. jump left to pc=2(if a>=0)
    '0000010100000000010100100001000000000110',  # add a+b, store(a+b) to c(pc=6)    
    '0000011000000000010100100001000000000110',  # sub a-b, store(a-b) to c(pc=6)
...
#PC starts from 1 in this program
...
while(flag):
    ...
    if(inst_set == 'Right' or to_Be_Processed == False):  # right instruction execution
        print('Inst_set is RIGHT or To be processed is FALSE')
